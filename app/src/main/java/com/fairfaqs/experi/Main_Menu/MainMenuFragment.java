package com.fairfaqs.experi.Main_Menu;
...
import com.fairfaqs.experi.ActivitesFragment.notificationTab.Notification_F;
import com.fairfaqs.experi.ActivitesFragment.notificationTab.Notification_F_New;
...
import com.fairfaqs.experi.ActivitesFragment.Discover_F;
import com.fairfaqs.experi.ActivitesFragment.Home_F;
import com.fairfaqs.experi.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.fairfaqs.experi.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.fairfaqs.experi.ActivitesFragment.Profile.Profile_Tab_F;
import com.fairfaqs.experi.R;
import com.fairfaqs.experi.Services.Upload_Service;
import com.fairfaqs.experi.SimpleClasses.Functions;
import com.fairfaqs.experi.SimpleClasses.Variables;
import com.fairfaqs.experi.ActivitesFragment.Video_Recording.Video_Recoder_A;
...
public class MainMenuFragment extends RootFragment {
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_sel_icon));
        title1.setText("Home");
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_unsel_icon));
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        Functions.black_status_bar(getActivity());
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_sel_icon));
                    ...
                    case 1:
                        ...
                        Functions.black_status_bar(getActivity());
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_sel_icon));
                    ...
                    case 3:
                        ...
                        // Onother_Tab_Click();
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_inbox_sel_icon));
                        //image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;
                    case 4:
                        ...
                        //  Onother_Tab_Click();
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_profile_sel_icon));
                        //   image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;
                }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        ...
                        break;
                    case 1:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_unsel_icon));
                        title.setTextColor(context.getResources().getColor(R.color.darkgray));
                        break;
    ...
    public void OnHome_Click() {
        ...
        //image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_create_video_icon));
        image.setImageDrawable(context.getResources().getDrawable(R.color.black));
    ...
    public void chatFragment(String receiverid, String name, String picture) {
        Chat_Activity chat_activity = new Chat_Activity(bundle -> {
