package com.fairfaqs.experi.Adapters;
    ...
    public void onBindViewHolder(final SoundList_Adapter.CustomViewHolder holder, final int i) {
        ...
        try {
            ...
            if(item.fav.equals("1"))
                holder.fav_btn.setImageDrawable(context.getDrawable(R.drawable.ic_bookmark_sel_icon));
            else
                holder.fav_btn.setImageDrawable(context.getDrawable(R.drawable.ic_bookmark_unsel_icon));
