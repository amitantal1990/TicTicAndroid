...
import com.fairfaqs.experi.ActivitesFragment.Profile.Private_Videos.PrivateVideo_F;
import com.fairfaqs.experi.ActivitesFragment.Setting_F;
...
import com.fairfaqs.experi.ActivitesFragment.Video_Recording.DraftVideos_A;
...
//        }
    ...
    private void setupTabIcons() {
        ...
        imageView3.setImageDrawable(getResources().getDrawable(R.drawable.ic_lock_unsel_icon));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 2:
                        create_popup_layout.clearAnimation();
                        create_popup_layout.setVisibility(View.GONE);
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_lock_sel_icon));
                        break;
                }
                tab.setCustomView(v);
            }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 2:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_lock_unsel_icon));
                        break;
                }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.request_id:
                        ManageRequest_F favourite_main_f = new ManageRequest_F();
                        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                        transaction.setCustomAnimations(R.anim.fade_in, R.anim.fade_out);
                        transaction.addToBackStack(null);
