...
import com.fairfaqs.experi.Adapters.Inbox_Adapter;
...
import com.fairfaqs.experi.Models.Inbox_Get_Set;
...
//        transaction.replace(R.id.Inbox_F, chat_activity).commit();
        ...
        Intent intent = new Intent(requireContext(), ChatNewActivity.class);
        Bundle args = new Bundle();
        args.putString("user_id", receiverid);
        args.putString("user_name",name);
        args.putString("user_pic",picture);
