package com.fairfaqs.experi.ActivitesFragment.Accounts;
...
import com.fairfaqs.experi.Models.User_Model;
...
public class Login_A extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            Log.e("TicTic_log", "signInResult:failed code=" + e.getStatusCode());
        }
    }
